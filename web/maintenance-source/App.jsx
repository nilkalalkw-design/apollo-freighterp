...
const REPORT_FOOTER_TEXT =
  "Designed by ApolloIT | Copyright \u00a9 2026 Apollo Connected / Maintenance Portal. All rights reserved.";
...
function App() {
      ...
      <div className="shell">
        <section className="auth-wrap">
          <div className="panel auth-panel">
            <img className="company-logo auth-logo" src={logo} alt="Apollo Connected logo" />
            <p className="eyebrow auth-eyebrow">APOLLO CONNECTED / MAINTENANCE</p>
            <h1><BrandName /></h1>
  ...
  return (
    <div className="shell">
      <header className="hero">
        <div>
          <img className="company-logo header-logo" src={logo} alt="Apollo Connected logo" />
          <p className="eyebrow">APOLLO CONNECTED / MAINTENANCE</p>
          <h1><BrandName /></h1>
  ...
  async function exportPdfReport(exportExpenses, start, end, totalsText, kind) {
    try {
      ...
      doc.setFontSize(16);
      doc.text("Apollo Connected / Maintenance Portal - Expense Report", 40, 40);
      doc.setFontSize(11);
...
function BrandName() {
  return (
    <>
      Apollo <span className="brand-mark">Connected</span>
    </>
  );
}
