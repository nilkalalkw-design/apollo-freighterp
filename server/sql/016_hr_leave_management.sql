...
create table if not exists hr_leave_balances (
    ...
    carry_forward numeric(8,1) not null default 0,
    adjustment numeric(8,1) not null default 0,
    used_days numeric(8,1) not null default 0,
    pending_days numeric(8,1) not null default 0,
    available_days numeric(8,1) not null default 0,
    projected_days numeric(8,1) not null default 0,
    updated_at timestamptz not null default now(),
    unique(user_name, year, leave_type_code)
);
...
create table if not exists hr_leave_ledger (
    ...
    days numeric(8,1) not null default 0,
    balance_after numeric(8,1) not null default 0,
